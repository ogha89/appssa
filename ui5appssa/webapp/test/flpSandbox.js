		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Aplicaciones  SmartAgri",
									"targetURL": "#nsaui5appssa-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"nsaui5appssa-display": {
								"semanticObject": "nsaui5appssa",
								"action": "display",
								"description": "Aplicaciones  SmartAgri",
								"title": "Aplicaciones  SmartAgri",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=nsa.ui5appssa",
									"url": sap.ui.require.toUrl("nsa/ui5appssa")
								}
							}
						}
					}
